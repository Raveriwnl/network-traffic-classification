...
DEFAULT_CONFIG = {
    ...
    "model_module": "cnn_bimobilemamba_avgpool",
    "model_builder": "build_cnn_bimobilemamba_avgpool_model",
    "model_kwargs": {
        "num_mamba_layers": 1,
        "mamba_d_state": 16,
        "mamba_d_conv": 5,
    ...
    "model_save_name": "huawei_cnn_bimobilemamba_avgpool_best.pt",
    "eval_model_path": None,
    "artifact_dir": "experiment_results/cnn_bimobilemamba_avgpool",
...
def main():
    run_training(
        ...
        description="Train Huawei CNN-BiMobileMamba-AvgPool model.",
        run_name="cnn_bimobilemamba_avgpool",
    )
