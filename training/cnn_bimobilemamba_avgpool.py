...
class CNNBiMobileMambaAvgPool(nn.Module):
    """CNN + bidirectional MobileMamba classifier with mean pooling for (B, 1000, 10)."""
...
def build_cnn_bimobilemamba_avgpool_model(
    input_shape=(1000, 10),
    num_classes=8,
    num_mamba_layers=2,
    mamba_d_state=16,
    ...
    return CNNBiMobileMambaAvgPool(
