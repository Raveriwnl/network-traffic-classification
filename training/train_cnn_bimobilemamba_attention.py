...
DEFAULT_CONFIG = {
    ...
    "model_save_name": "huawei_cnn_bimobilemamba_attention_best.pt",
    "eval_model_path": None,
    "artifact_dir": "experiment_results/cnn_bimobilemamba_attention",
...
def main():
    run_training(
        ...
        description="Train Huawei CNN-BiMobileMamba-Attention model.",
        run_name="cnn_bimobilemamba_attention",
    )
