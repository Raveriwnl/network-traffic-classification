...
class CNNBiMambaAvgPool(nn.Module):
    """CNN + bidirectional Mamba classifier with mean pooling for (B, 1000, 10)."""
...
def build_cnn_bimamba_avgpool_model(
    input_shape=(1000, 10),
    num_classes=8,
    num_mamba_layers=2,
    mamba_dropout=0.15,
