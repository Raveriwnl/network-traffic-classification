...
DEFAULT_CONFIG = {
    ...
    "model_module": "cnn_mobilemamba_attention",
    "model_builder": "build_cnn_mobilemamba_attention_model",
    "model_kwargs": {
        "num_mamba_layers": 1,
        "mamba_d_state": 16,
        "mamba_d_conv": 5,
    ...
    "model_save_name": "huawei_cnn_mobilemamba_attention_best.pt",
    "eval_model_path": None,
    "artifact_dir": "experiment_results/cnn_mobilemamba_attention",
...
def main():
    run_training(
        ...
        description="Train Huawei CNN-MobileMamba-Attention model.",
        run_name="cnn_mobilemamba_attention",
    )
